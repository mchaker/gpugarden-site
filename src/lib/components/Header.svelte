<header class="bg-white p-2 text-zinc-900 dark:bg-black dark:text-zinc-100">
	...
	<nav class="mt-4 flex flex-wrap justify-center gap-4 text-sm">
		...
		<a href="https://swarmui.gpu.garden/" target="_blank" class="hover:underline">🖼️ SwarmUI</a>
		<a href="https://oui.gpu.garden/" target="_blank" class="hover:underline">📝 Open WebUI</a>
		<a href="https://status.gpu.garden/" target="_blank" class="hover:underline">🩺 Status</a>
	</nav>
</header>

...
<svelte:head>
  ...
  <meta property="og:description" content="Built for TouhouAI — welcome to our beautifully weird little corner of the web." />
...
>
  ...
  <p>
    Welcome to <strong>gpu.garden</strong> — a beautiful little corner of the
    web, lovingly hosted in the
    <a
  ...
  <ul class="mt-2">
    ...
    <li>
      ...
      <em>
        Feel free to sign up! Once you do, reach out to astro to
        activate your account — contact them via
        <a
  ...
  <ul class="mt-1 space-y-3 text-sm">
    ...
    <li>
      🪴
      <a href="/" class="font-medium text-[#f22b00] hover:text-[#ff6747]">
        gpu.garden
      </a>
      – homepage
    </li>
    ...
    <li>
      ...
      – bare-bones ComfyUI (no SwarmUI)
      (⚠️ requires login on swarmui.gpu.garden first)
    </li>
